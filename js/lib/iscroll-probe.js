    ...
    IScroll.prototype = {
        ...
        resetPosition: function(time) {
            ...
            if (!this.hasVerticalScroll || this.y > 0) {
                ...
                // 自定义代码
                if (this.wrapper.querySelector('.scroller-pullUp') && this.wrapper.querySelector('.scroller-pullUp').className.match('flip')) {
                    y = this.maxScrollY - 50;
                } else {
                    y = this.maxScrollY;
                }
                // if ($('#scroller-pullUp').hasClass('flip')) {
...
(function(window) {
    function IScrollLoadData(wrapperEl, contentEl, dropTopAction, dropBottomAction, limit) {
        ...
        this.scrollerEl = this.wrapper.querySelector('.scroller_v');
    ...
    IScrollLoadData.prototype.createIScroll = function() {
        ...
        this.myScroll.on('scroll', function() {
            if (this.y > 50 &&
                (!self.pullDownEl.className.match('flip') &&
                    !self.pullDownEl.className.match('scroller-loading'))) {
                self.pullDownEl.className = 'scroller-pullDown flip';
                ...
                self.pullDownEl.className = 'scroller-pullDown';
                ...
                (!self.pullUpEl.className.match('flip') &&
                    !self.pullUpEl.className.match('scroller-loading'))) {
                self.pullUpEl.className = 'scroller-pullUp flip';
                self.pullUpEl.querySelector('.pullUpLabel').innerHTML = self.releaseLoading_Text;
            } else if (this.y > (this.maxScrollY -45) && self.pullUpEl.className.match('flip')) {
                self.pullUpEl.className = 'scroller-pullUp';
                self.pullUpEl.querySelector('.pullUpLabel').innerHTML = self.pullUpLabel_Text;
            }
        });
        this.myScroll.on('scrollEnd', function() {
            if (self.pullDownEl.className.match('flip')) {
                self.pullDownEl.className = 'scroller-loading scroller-pullDown';
                ...
                self.pullUpEl.className = 'scroller-loading scroller-pullUp';
        ...
        this.myScroll.on('refresh', function() {
            if (self.pullDownEl.className.match('scroller-loading')) {
                self.pullDownEl.className = 'scroller-pullDown';
                self.pullDownEl.querySelector('.pullDownLabel').innerHTML = self.pullDownLabel_Text;
                this.scrollTo(0,0,300, IScroll.utils.ease.quadratic);
            } else if (self.pullUpEl.className.match('scroller-loading')) {
                self.pullUpEl.className = 'scroller-pullUp';
                self.pullUpEl.querySelector('.pullUpLabel').innerHTML = self.pullUpLabel_Text;
            }
        });
